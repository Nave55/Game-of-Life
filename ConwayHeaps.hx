class Conway extends hxd.App {
    ...
    static final gen = hxd.Rand.create();

    static var elements: Array<Array<h2d.SpriteBatch.BatchElement>> = [];
    static var cells: Array<Array<Int>> = [];
    static var tmp_cells: Array<Array<Int>> = [];
    static var running = false;
    static var green_tile: h2d.Tile;
    static var dark_grey_tile: h2d.Tile;
    static var updatesPerSecond:Float = 12;
    static var updateInterval:Float = 1.0 / 12;
